...
const GREETING_LS_KEY = 'ndbot_greeting_last';
...
const GREETINGS = {
  fr: "Bonjour, je suis l'assistant de la commune de Tenneville. Quelle est votre question ?",
  nl: "Goedendag, ik ben de assistent van de gemeente Tenneville. Wat is uw vraag?",
  de: "Guten Tag, ich bin der Assistent der Gemeinde Tenneville. Was ist Ihre Frage?",
};
    ...
    _ensureVoices(() => {
      ...
      function speakNext() {
        ...
        utt.onerror = (e) => {
          ...
          console.warn('[NDBot Voice] TTS chunk', idx, ':', e.error);
...
function startListening() {
  ...
  _recognition.onerror = (e) => {
    ...
    console.warn('[NDBot Voice] STT:', e.error);
    _setState('error_stt');
